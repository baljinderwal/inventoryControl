...
// SVGs for logos will be defined here. For brevity, I'll use simple placeholders.
// In a real scenario, you'd have the full SVG code.
const TechLogo = ({ name, children }) => {
  ...
  return (
    ...
    >
      <Box sx={{ height: 48, mb: 1 }}>{children}</Box>
...
const techStack = [
  {
    name: 'React',
    logo: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1093 977" fill="#61dafb" width="48" height="48">
  ...
  { name: 'Vite', logo: <div style={{width: 48, height: 48, backgroundColor: 'grey'}} /> },
  { name: 'Material-UI', logo: <div style={{width: 48, height: 48, backgroundColor: 'grey'}} /> },
  { name: 'Framer Motion', logo: <div style={{width: 48, height: 48, backgroundColor: 'grey'}} /> },
  { name: 'React Router', logo: <div style={{width: 48, height: 48, backgroundColor: 'grey'}} /> },
  { name: 'TanStack Query', logo: <div style={{width: 48, height: 48, backgroundColor: 'grey'}} /> },
];
        ...
        {techStack.map((tech, index) => (
          <Grid item xs={6} sm={4} md={2} key={index}>
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <TechLogo name={tech.name}>{tech.logo}</TechLogo>
            </motion.div>
          </Grid>
        ))}
      </Grid>
